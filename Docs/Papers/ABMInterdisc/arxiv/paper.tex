...
%https://arxiv.org/pdf/1905.00075.pdf % citation network dataset
...
\bibitem[Akerlof and Michaillat, 2018]{akerlof2018persistence}
...
\newblock {\em Urban Dynamics and Simulation Models}, pages 119--123.

\bibitem[Bornmann et~al., 2020]{doi10.1162qssa00008}
...
\newblock {\em Quantitative Science Studies}, 1(1):331--346.

\bibitem[Brown et~al., 2020]{brown_murray_furlong_coco_dablander_2020}
...
\bibitem[Chavalarias, 2016]{chavalarias2016s}
Chavalarias, D. (2016).
\newblock What's wrong with science?
\newblock {\em Scientometrics}, pages 1--23.

\bibitem[Clement et~al., 2019]{clement2019use}
Clement, C.~B., Bierbaum, M., O'Keeffe, K.~P., and Alemi, A.~A. (2019).
\newblock On the use of arxiv as a dataset.

\bibitem[Dionne et~al., 2019]{dionne2019diversity}
...
\bibitem[Ellemers et~al., 2020]{Ellemers7561}
...
\bibitem[Feliciani et~al., 2019]{feliciani2019scoping}
Feliciani, T., Luo, J., Ma, L., Lucas, P., Squazzoni, F., Maruvsic, A., and
  Shankar, K. (2019).
\newblock A scoping review of simulation models of peer review.
\newblock {\em Scientometrics}, 121(1):555--594.

\bibitem[Frodeman, 2013]{frodeman2013sustainable}
Frodeman, R. (2013).
\newblock {\em Sustainable knowledge: A theory of interdisciplinarity}.
\newblock Springer.

\bibitem[Giere, 2010a]{giere2010agent}
Giere, R.~N. (2010a).
\newblock An agent-based conception of models and scientific representation.
\newblock {\em Synthese}, 172(2):269--281.
...
\bibitem[Gross and Bergstrom, 2019]{gross2019contest}
Gross, K. and Bergstrom, C.~T. (2019).
\newblock Contest models highlight inherent inefficiencies of scientific
  funding competitions.
\newblock {\em PLoS biology}, 17(1).

\bibitem[Hofstra et~al., 2020]{Hofstra9284}
...
\bibitem[Jang et~al., 2019]{jang2019coevolutionary}
...
\newblock {\em Journal of Artificial Societies \& Social Simulation}, 22(3).

\bibitem[Kovanis et~al., 2016]{kovanis2016complex}
...
\newblock Complex systems approach to scientific publication and peer-review
  ...
  data.
\newblock {\em Scientometrics}, 106(2):695--715.
...
\newblock {\em Journal of the Association for Information Science and
  Technology}, 61(1):126--131.

\bibitem[Leydesdorff and Ivanova, 2020]{leydesdorff2020measurement}
...
\bibitem[Pavlidis et~al., 2014]{pavlidis2014together}
Pavlidis, I., Petersen, A.~M., and Semendeferi, I. (2014).
\newblock Together we stand.
\newblock {\em Nature Physics}, 10(10):700.

\bibitem[Pluchino et~al., 2019]{pluchino2019exploring}
...
\newblock Exploring the role of interdisciplinarity in physics: Success, talent
  and luck.
\newblock {\em PloS one}, 14(6).

\bibitem[Raimbault, 2017]{raimbault2017knowledge}
Raimbault, J. (2017).
\newblock An applied knowledge framework to study complex systems.
\newblock {\em Forthcoming in CSDM2017 proceedings. arXiv:1706.09244 at
  https://arxiv.org/abs/1706.09244}.
...
\bibitem[Rouse et~al., 2018]{rouse2018modeling}
...
\bibitem[Shafiee and Berglund, 2019]{shafiee2019agent}
...
\newblock {\em Journal of Simulation}, 13(1):1--13.

\bibitem[Shneiderman, 2018]{shneiderman2018twin}
Shneiderman, B. (2018).
\newblock Twin-win model: A human-centered approach to research success.
\newblock {\em Proceedings of the National Academy of Sciences},
  115(50):12590--12594.

\bibitem[{Thurner} et~al., 2019]{2019arXiv191003628T}
{Thurner}, S., {Liu}, W., {Klimek}, P., and {Cheong}, S.~A. (2019).
\newblock {The role of mainstreamness and interdisciplinarity for the relevance
  of scientific papers}.
\newblock {\em arXiv e-prints}, page arXiv:1910.03628.
...
\bibitem[Urbanska et~al., 2019]{urbanska2019does}
...
\newblock {\em PloS one}, 14(9).

\bibitem[van Vlokhoven, 2019]{VANVLOKHOVEN2019751}
van Vlokhoven, H. (2019).
\newblock The effect of open access on research quality.
\newblock {\em Journal of Informetrics}, 13(2):751 -- 756.

\bibitem[Zeng et~al., 2019]{zeng2019increasing}
Zeng, A., Shen, Z., Zhou, J., Fan, Y., Di, Z., Wang, Y., Stanley, H.~E., and
  Havlin, S. (2019).
\newblock Increasing trend of scientists to switch between topics.
\newblock {\em Nature communications}, 10(1):1--11.
